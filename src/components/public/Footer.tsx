...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#050810] border-t border-white/5 pt-20 pb-12">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-24 mb-20">
        
        {/* Brand Column */}
        <div className="space-y-6">
          <Link href="/" className="flex items-center gap-2 group relative z-50 mb-2">
        ...
        {/* Links: Platform */}
        <div className="space-y-6">
          <h4 className="text-xs font-black uppercase tracking-widest text-white/50">Platform</h4>
        ...
        {/* Links: Account */}
        <div className="space-y-6">
          <h4 className="text-xs font-black uppercase tracking-widest text-white/50">Account</h4>
          <nav className="flex flex-col gap-4">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/[0.03] border border-white/5 rounded-2xl p-4 flex items-center gap-3">
              <div className="p-2 rounded-lg bg-accent/10 text-accent">
                  <Heart className="w-5 h-5 fill-accent opacity-80" />
              </div>
